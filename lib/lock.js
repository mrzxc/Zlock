    ...
    window.Zlock = function () {
        ...
        _createClass(Zlock, [{
            ...
            value: function HCircleInit() {
                ...
                var ifColumn = this.ctx.canvas.width < this.ctx.canvas.height;
                var r = this.r = ifColumn ? this.ctx.canvas.width / (2 + 4 * this.matrixNum) : this.ctx.canvas.height / (2 + 4 * this.matrixNum);
                var arr = [];
                var vArr = [];
